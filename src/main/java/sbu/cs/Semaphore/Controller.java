...
public class Controller {
    ...
    public static void main(String[] args) {
        ...
        Operator operator1 = new Operator(semaphore , "operator1");
        Operator operator2 = new Operator(semaphore , "operator2");
        Operator operator3 = new Operator(semaphore , "operator3");
        Operator operator4 = new Operator(semaphore , "operator4");
        Operator operator5 = new Operator(semaphore , "operator5");
